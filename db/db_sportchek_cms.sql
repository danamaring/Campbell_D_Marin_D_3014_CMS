...
--
-- Host: mysql
-- Generation Time: Mar 28, 2020 at 03:12 AM
...
(34, 'Bolle Freeze Ski n Snowboard Goggles - Matte Black with Vermillon Lens.jpg', 'Bolle Freeze Ski & Snowboard Goggles - Matte Black with Vermillon Lens', '$23.98', 'The Freeze is one of our most versatile goggle in Bolle collection. The classic frame design combined with dual lens technolgy exceds all expectations when it comes to the fit and performance features of this goggle.'),
...
INSERT INTO `tbl_products_sport` (`products_sport_id`, `product_id`, `sport_id`) VALUES
(8, 1, 1),
(9, 2, 1),
(10, 3, 1),
(11, 4, 1),
